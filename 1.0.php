...
function ASCASASAAQQB($delay)
{
    ...
    echo "\r\x1b[1;9" . rand(1, 9) . "m Tool Auto TDS DINH LUC       \r";
}
*/
function ASCASASAAQQB($delay)
{
    for ($i = $delay; $i >= 0; $i--) {
        echo " \033[1;93m[\033[1;97mDINH_LUC\033[1;93m] [\033[1;97m" . $i . "\033[1;93m] [\033[1;97mx.x.x.x.x\033[1;93m]       \r";
        usleep(166666);
        echo " \033[1;93m[\033[1;97mDINH_LUC\033[1;93m] [\033[1;97m" . $i . "\033[1;93m] [\033[1;97mX.x.x.x.x\033[1;93m]       \r";
       usleep(166666);
       echo " \033[1;93m[\033[1;97mDINH_LUC\033[1;93m] [\033[1;97m" . $i . "\033[1;93m] [\033[1;97mX.X.x.x.x\033[1;93m]       \r";
    ...
    //echo "\r\033[1;9" . rand(1, 9) . "m " . "Tool Bản Quyền DINH LUC" . "       \r";
//    kiemtramang_dinhluc();
}
