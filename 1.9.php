...
if ($reg['status'] == 1){
$dem++;
echo "\033[1;34m[\033[1;33m".$dem."\033[1;34m]\e[1;32m⌠\e[1;33mDINH_LUC\e[1;32m⌡\033[1;91m | \033[1;36m".date("H:i")."\033[1;31m | \033[1;".rand(31,37)."m"." REG\033[1;31m | \033[1;37m".$reg['data']['name']."\033[1;92m | ".$reg['data']['id']."\n";
if ($upavt == 'y' || $upavt == 'Y'){
...
echo "\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
    ...
    echo $dragonx.$xnhac."Cảm ơn Bạn Đã Sử Dụng Tool By DINHLUC\n";
...
"cookie: ".$ck
    ...
    $data = [
        ...
        "variables" =>
            '{"input":{"bio":"DINH LUC","categories":["2347428775505624"],"creation_source":"comet","name":"' .
            ranm($ho) .
            " " .
            ranm($tendem) .
            " " .
